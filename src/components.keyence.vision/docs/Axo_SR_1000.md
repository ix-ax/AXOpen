...
_Keyence SR-1000 fixed barcode reader_
...
View the library source at [`Axo_SR_1000.st`](https://github.com/Inxton/AXOpen/tree/3-unify-showcase/src/components.keyence.vision/ctrl/src/Axo_SR_1000/Axo_SR_1000.st).
...
[!code-yaml[](../../showcase/app/hwc/plc_line.hwl.yml?name=KeyenceSr1000Device)]

## IO system wiring

[!code-yaml[](../../showcase/app/hwc/plc_line.hwl.yml?name=KeyenceSr1000IoSystem)]
