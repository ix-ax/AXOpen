...
{
    public partial class AxoOmnicore : AXOpen.Core.AxoComponent, AXOpen.Components.Abstractions.Robotics.IAxoRobotics
    {
        ...
        private void InitializeMessenger()
        {
            List<KeyValuePair<ulong, AxoMessengerTextItem>> messengerTextList = new List<KeyValuePair<ulong, AxoMessengerTextItem>>
            {
                ...
                new KeyValuePair<ulong, AxoMessengerTextItem>(710, new AxoMessengerTextItem("Hw configuration error. Value of Config.HWIDs.HwID_DI_64_bytes is zero."                                                       ,"Check the hardware configuration.")),
    ...
    public partial class AxoOmnicore_Component_Status : AXOpen.Components.Robotics.AxoRobot_Status
    {
