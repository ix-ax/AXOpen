...
namespace AXOpen.Components.Abb.Robotics
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static app_axopen_components_abb_roboticsTwinController SecurePlc { get; }
    ...
    {
        public static app_axopen_components_abb_roboticsTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}