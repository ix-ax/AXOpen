...
namespace librarytemplate
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static string TargetIp { get; } = "192.168.100.1";//Environment.GetEnvironmentVariable("AXTARGET"); // <- replace by your IP 
    ...
    {
        public static axopen_data_appTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}
