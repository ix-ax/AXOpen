    ...
    public class MongoDbSecuredRepositoryTest : RepositoryBaseTests
    {
        public override void Init()
        {
            if (this.repository == null)
            {
                ...
                this.repository = AXOpen.Data.MongoDb.Repository.Factory<DataTestObject>(parameters);

                this.repository_altered_structure = AXOpen.Data.MongoDb.Repository.Factory<DataTestObjectAlteredStructure>(parametersAltered);
