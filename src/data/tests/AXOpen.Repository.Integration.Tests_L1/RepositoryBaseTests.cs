...
namespace AXOpen.Repository.Integration.Tests
{
   ...
   public abstract class RepositoryBaseTests
   {
       ...
       public void CreateTest()
       {
           ...
           //-- Assert
           Assert.That(repository.GetRecords(id).Count(), Is.EqualTo(1));
       }
       ...
       public void ReadTest()
       {
           ...
           Assert.That(testObj.Name, Is.EqualTo(recordName));
           Assert.That(testObj.Age, Is.EqualTo(25));
       }
       ...
       public void UpdateTest()
       {
           ...
           //-- Assert
           Assert.That(testObj.Name, Is.EqualTo("Pepo post update"));
           Assert.That(testObj.Age, Is.EqualTo(44));
       ...
       public void UpdateWithDelegatesTest()
       {
           ...
           Assert.That(testObj.Name, Is.EqualTo("Pepo post update"));
           Assert.That(testObj.Age, Is.EqualTo(44));
           Assert.That(testObj._Modified, !Is.EqualTo(testObj._Created));
           Assert.That(DateTime.Now.Subtract(new TimeSpan(0, 0, 3)) < testObj._Modified, Is.True);
       ...
       {
           //-- Assert
           Assert.That(() => repository.Read("nonexisting_record"), Throws.TypeOf<UnableToLocateRecordId>());
       }
       [Test()]
       ...
       public void AlteredStructureTest()
       {
           ...
           repository.Create("test3", testObject1);
       ...
       public void DateTimeProviderTest()
       {
           ...
           //-- Assert
           Assert.That(repository.Read(testObject.Name).Name, Is.EqualTo("SimulatedTimePepo"));
           Assert.That(repository.Read(testObject.Name).Age, Is.EqualTo(100));
           Assert.That(new DateTime(1976, 9, 1), Is.EqualTo(repository.Read(testObject.Name)._Created));
           Assert.That(repository.Read(testObject.Name)._Modified, Is.EqualTo(new DateTime(1979, 12, 4)));
       }
