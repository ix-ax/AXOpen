...
[!code-smalltalk[](../../showcase/app/src/DataExamples/AxoDataPersistentExchangeExample.st?name=PersistentAttribute)]


### Create an instance of the exchange manager
Create an instance of the manager and call its `.Run()` method within the Context.

[!code-smalltalk[](../../showcase/app/src/DataExamples/AxoDataPersistentExchangeExample.st?name=ContextDeclaration)]
...
[!code-smalltalk[](../../showcase/app/src/DataExamples/AxoDataPersistentExchangeExample.st?name=ConcurrentUsage)]
