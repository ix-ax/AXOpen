...
[!code-smalltalk[](../../showcase/app/ix-blazor/showcase.blazor/Pages/data/Rendering.razor?name=CommandView)]

![Command](assets/Command.png)

If you use `Status` presentation type, data will be only displayed and cannot be manipulated.

[!code-smalltalk[](../../showcase/app/ix-blazor/showcase.blazor/Pages/data/Rendering.razor?name=StatusView)]
