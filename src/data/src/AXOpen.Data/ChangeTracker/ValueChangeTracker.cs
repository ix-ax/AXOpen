...
namespace AXOpen.Data
{
    public class ValueChangeTracker
    {
        ...
        public void SaveObservedChanges(IBrowsableDataObject plainObject)
        {
            ...
            {
                AxoApplication.Current.Logger.Information($"Value change {change.ValueTag.Symbol} of {plainObject._EntityId} from {change.OldValue} to {change.NewValue} changed by user action.", _as.User.Identity);
            }
