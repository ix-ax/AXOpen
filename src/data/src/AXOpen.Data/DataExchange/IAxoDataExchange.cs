...
namespace AXOpen.Data
{
    public partial interface IAxoDataExchange
    {
        ...
        void ExportData(string path, Dictionary<string, ExportData> customExportData = null, eExportMode exportMode = eExportMode.First, int firstNumber = 50, int secondNumber = 100, eFileType exportFileType = eFileType.csv, char separator = ';');
