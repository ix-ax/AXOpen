...
[!code-smalltalk[](../../showcase/app/src/core/AXOpen.AxoComponent/AxoComponentHeaderOnlyExample.st?name=Implementation)]

**How to use `AxoComponent`**

The instance of the extended `AxoComponent` must be defined inside the `AxoContext`.
[!code-smalltalk[](../../showcase/app/src/core/AXOpen.AxoComponent/AxoComponentHeaderOnlyExample.st?name=Using)]
...
[!code-smalltalk[](../../showcase/app/src/core/AXOpen.AxoComponent/AxoComponentExample.st?name=Implementation)]
...
[!code-smalltalk[](../../showcase/app/src/core/AXOpen.AxoComponent/AxoComponentExample.st?name=ClassDefinitions)]

Instantiate and call the `AxoComponent` instance.

[!code-smalltalk[](../../showcase/app/src/core/AXOpen.AxoComponent/AxoComponentExample.st?name=Using)]
