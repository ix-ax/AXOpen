...
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoTask/AxoTaskDocuExample.st?range=4-16,60)]
...
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoTask/AxoTaskDocuExample.st?range=4-27,60)]
...
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoTask/AxoTaskDocuExample.st?name=AxoTaskInvoke)]
...
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoTask/AxoTaskDocuExample.st?name=AxoTaskInvokeDone)]
Invoking the AxoTask and waiting for its completion at the different places.
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoTask/AxoTaskDocuExample.st?name=AxoTaskInvokeDoneSeparatelly)]
Checking if the AxoTask is executing.
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoTask/AxoTaskDocuExample.st?name=AxoTaskRunning)]
Check for the AxoTask's error state. 
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoTask/AxoTaskDocuExample.st?name=AxoTaskError)]
...
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoTask/AxoTaskDocuExample.st?name=AxoTaskEventLikeMethods)]
...
[!code-csharp[](../../showcase/app/ix-blazor/showcase.blazor/Pages/Core/DocuExamples/AxoTaskDocu.razor?name=AxoTaskViewControlable)]
or display only:
[!code-csharp[](../../showcase/app/ix-blazor/showcase.blazor/Pages/Core/DocuExamples/AxoTaskDocu.razor?name=AxoTaskViewDisplayOnly)]
...
[!code-csharp[](../../showcase/app/ix-blazor/showcase.blazor/Pages/Core/DocuExamples/AxoTaskDocu.razor?name=RenderableContentControlCommand)]
or display only when the value of the `Presentation` is `Status`
[!code-csharp[](../../showcase/app/ix-blazor/showcase.blazor/Pages/Core/DocuExamples/AxoTaskDocu.razor?name=RenderableContentControlStatus)]
