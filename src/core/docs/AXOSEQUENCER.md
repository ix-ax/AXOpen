...
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoSequencer/AxoSequencerDocuExample.st?range=4-11,84)]
#### Initialization
Initialization of the context needs to be called first. It does not need to be called cyclically, just once.
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoSequencer/AxoSequencerDocuExample.st?name=Initialize)]
#### Open
...
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoSequencer/AxoSequencerDocuExample.st?name=Open)]
#### Step
Example of the most simple use of the `Execute()` method of the `AxoStep` class, only with the AxoCoordinator defined. 
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoSequencer/AxoSequencerDocuExample.st?name=SimpleStep)]
...
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoSequencer/AxoSequencerDocuExample.st?name=EnableStep)]
Example of use of the `Execute()` method of the `AxoStep` class with all three parameters defined.
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoSequencer/AxoSequencerDocuExample.st?name=FullStep)]
