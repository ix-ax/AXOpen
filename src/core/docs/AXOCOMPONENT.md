...
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoComponent/AxoComponentHeaderOnlyExample.st?name=Implementation)]

**How to use `AxoComponent`**

The instance of the extended `AxoComponent` must be defined inside the `AxoContext`.
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoComponent/AxoComponentHeaderOnlyExample.st?name=Using)]
...
[!code-csharp[](../../showcase/app/ix-blazor/showcase.blazor/Pages/Core/AxoCore/AxoComponentHeaderOnlyExample.razor?name=RenderedView)]
...
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoComponent/AxoComponentExample.st?name=Implementation)]
...
[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoComponent/AxoComponentExample.st?name=ClassDefinitions)]

Instantiate and call the `AxoComponent` instance.

[!code-smalltalk[](../../showcase/app/src/CoreExamples/AXOpen.AxoComponent/AxoComponentExample.st?name=Using)]

UI side of the `AxoComponent`.
[!code-csharp[](../../showcase/app/ix-blazor/showcase.blazor/Pages/Core/AxoCore/AxoComponentExample.razor?name=RenderedView)]
