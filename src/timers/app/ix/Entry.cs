...
namespace timers_app
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static timers_appTwinController SecurePlc { get; }
    ...
    {
        public static timers_appTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}