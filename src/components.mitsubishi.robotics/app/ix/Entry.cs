...
namespace AXOpen.Components.Mitsubishi.Robotics
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static app_axopen_components_mitsubishi_roboticsTwinController SecurePlc { get; }
    ...
    {
        public static app_axopen_components_mitsubishi_roboticsTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}
