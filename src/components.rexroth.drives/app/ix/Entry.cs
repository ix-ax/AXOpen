...
namespace AXOpen.Components.Rexroth.Drives
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static app_axopen_components_rexroth_drivesTwinController SecurePlc { get; }
    ...
    {
        public static app_axopen_components_rexroth_drivesTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}
