...
_Rexroth IndraDrive servo drive_

Generated documentation for the `AxoIndraDrive` component.
...
View the library source at [`AxoIndraDrive.st`](https://github.com/Inxton/AXOpen/tree/3-unify-showcase/src/components.rexroth.drives/ctrl/src/AxoIndraDrive/AxoIndraDrive.st).
...
PROFINET hardware template at `showcase/app/hwc/library_templates/rexroth_indradrive/`.

## Device instantiation

[!code-yaml[](../../showcase/app/hwc/plc_line.hwl.yml?name=RexrothIndraDriveDevice)]

## IO system wiring

[!code-yaml[](../../showcase/app/hwc/plc_line.hwl.yml?name=RexrothIndraDriveIoSystem)]
