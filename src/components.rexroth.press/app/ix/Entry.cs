...
namespace AXOpen.Components.Rexroth.Press
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static app_axopen_components_rexroth_pressTwinController SecurePlc { get; }
    ...
    {
        public static app_axopen_components_rexroth_pressTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}
