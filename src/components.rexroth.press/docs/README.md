...
The **components.rexroth.press** is a set of libraries covering the product portfolio of the pressing systems from the vendor [Rexroth](https://www.boschrexroth.com/en/dc/) for the target PLC platform [Siemens AX](https://www.siemens.com/global/en/products/automation/industry-software/automation-software/simatic-ax.html) and [AxOpen](https://github.com/ix-ax/AXOpen?tab=readme-ov-file) framework.
