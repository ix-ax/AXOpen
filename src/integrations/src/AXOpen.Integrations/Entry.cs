...
namespace axopen_integrations
{
    ...
    public class TwinConnectorSelector
    {
        ...
        private static string CertificatePath = "..\\..\\app\\certs\\plc_line\\plc_line.cer"; //NFI why, but it works
        // <= Do not commit any changes to the following variables. You may modify them locally, but committing the changes will mess up the nightly build.
        ...
        public static axopen_integrationsTwinController SecurePlc { get; }
    ...
    {
        public static axopen_integrationsTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}
