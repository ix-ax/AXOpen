...
{
    public partial class AxoKrc5View : AxoComponentViewBase<AxoKrc5>
    {
    ...
    public class AxoKrc5StatusView : AxoKrc5View
    {
        public AxoKrc5StatusView()
        {
            this.ViewType = eViewType.Status;
        }
    }

    public class AxoKrc5CommandView : AxoKrc5View
    {
        public AxoKrc5CommandView()
        {
            this.ViewType = eViewType.Command;
        }
    }

    public class AxoKrc5SpotView : AxoKrc5View
    {
        public AxoKrc5SpotView()
        {
