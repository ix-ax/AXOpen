#define axopen_components_kuka_robotics
...
namespace AXOpen.Components.Kuka.Robotics
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static string TargetIp { get; } = "10.1.100.90";//"192.168.100.120";//Environment.GetEnvironmentVariable("AXTARGET"); // <- replace by your IP 
        ...
        private static string CertificatePath = "..\\certs\\plc_main\\plc_main.cer"; //"..\\certs\\plc_line\\plc_line.cer";
        // <= Do not commit any changes to the following variables. You may modify them locally, but committing the changes will mess up the nightly build.
