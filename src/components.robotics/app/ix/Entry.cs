...
namespace AXOpen.Components.Robotics
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static app_axopen_components_roboticsTwinController SecurePlc { get; }
    ...
    {
        public static app_axopen_components_roboticsTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}
