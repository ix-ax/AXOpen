#define axopen_components_dukane_welders
...
namespace AXOpen.Components.Dukane.Welders
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static string TargetIp { get; } = "10.1.100.60";//Environment.GetEnvironmentVariable("AXTARGET"); // <- replace by your IP 
        ...
        public static app_axopen_components_dukane_weldersTwinController SecurePlc { get; }
    ...
    public static class Entry
    {
        ...
        public static app_axopen_components_dukane_weldersTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
