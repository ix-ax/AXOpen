...
namespace AXOpen.Components.Festo.Drives
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static app_axopen_components_festo_drivesTwinController SecurePlc { get; }
    ...
    {
        public static app_axopen_components_festo_drivesTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}