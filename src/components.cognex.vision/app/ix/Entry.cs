...
namespace AXOpen.Components.Cognex.Vision
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static app_axopen_components_cognex_visionTwinController SecurePlc { get; }
    ...
    {
        public static app_axopen_components_cognex_visionTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}