    ...
    public partial class AxoDataman : AXOpen.Core.AxoComponent, AXOpen.Components.Abstractions.IAxoCodeReader
    {
        ...
        private void InitializeMessenger()
        {
            List<KeyValuePair<ulong, AxoMessengerTextItem>> messengerTextList = new List<KeyValuePair<ulong, AxoMessengerTextItem>>
            {
                ...
                new KeyValuePair<ulong, AxoMessengerTextItem>(765, new AxoMessengerTextItem("Hw configuration error. Value of hwIdSoftEventControl is zero."                                                                ,"Check the hardware configuration.")),
                ...
                new KeyValuePair<ulong, AxoMessengerTextItem>(771, new AxoMessengerTextItem("Hw configuration error. Value of hwIdResultData is zero."                                                                      ,"Check the hardware configuration.")),
                ...
                new KeyValuePair<ulong, AxoMessengerTextItem>(777, new AxoMessengerTextItem("Hw configuration error. Value of hwIdUserData is zero."                                                                        ,"Check the hardware configuration.")),
