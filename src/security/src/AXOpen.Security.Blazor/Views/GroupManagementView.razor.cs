...
namespace AxOpen.Security.Views
{
    public partial class GroupManagementView
    {
        ...
        public void AssignRoles()
        {
            ...
            if (result.Succeeded)
            {
                _alertDialogService.AddAlertDialog("Success", Localizer["Updated!"], Localizer["Group successfully updated!"], 10);
            }
            else
            {
                _alertDialogService.AddAlertDialog("Warning", Localizer["Not updated!"], Localizer["Group was not updated."], 10);
            }
        ...
        public void CreateGroup()
        {
            ...
            {
                _alertDialogService.AddAlertDialog("Warning", Localizer["Wrong name!"], Localizer["Wrong group name"], 10);
                return;
            }
            var result = _roleGroupManager.CreateGroup(newGroupName);
            if (result.Succeeded)
            {
                _alertDialogService.AddAlertDialog("Success", Localizer["Created!"], Localizer["Group successfully created!"], 10);
            }
            else
            {
                _alertDialogService.AddAlertDialog("Warning", Localizer["Not created!"], Localizer["Group was not created."], 10);
            }
            StateHasChanged();
        }
        ...
        public void DeleteGroup(Group group)
        {
            ...
            if (result.Succeeded)
            {
                _alertDialogService.AddAlertDialog("Success", Localizer["Deleted!"], Localizer["Group successfully deleted"], 10);
            }
            else
            {
                _alertDialogService.AddAlertDialog("Warning", Localizer["Not deleted!"], Localizer["Group was not deleted."], 10);
            }
            StateHasChanged();
        }
    }
