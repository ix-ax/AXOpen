...
var AxoProcessDataManager = Entry.Plc.Ctx.AxoDataFragmentsExchangeContext.DataManager.CreateDataFragments<AxoDataFramentsExchangeExample.AxoProcessDataManager>();
...
Entry.Plc.Ctx.AxoDataDistributedContext.ControlledUnit_1.EntityHeader.SetRepository(distributedHeaderRepository);
Entry.Plc.Ctx.AxoDataDistributedContext.ControlledUnit_2.EntityHeader.SetRepository(distributedHeaderRepository);
Entry.Plc.Ctx.AxoDataDistributedContext.ControlledUnit_1.ProcessData.SetRepository(distributedStationRepository);
Entry.Plc.Ctx.AxoDataDistributedContext.ControlledUnit_2.ProcessData.SetRepository(distributedStationRepository);
...
static string CreateJsonRepositoryDirectory(string path = "JSONREPOS")
{
    ...
    var repositoryDirectory = Path.GetFullPath(Path.Combine(executingAssemblyFile.Directory!.FullName, "..", "..", "..", "..", "..", path));
