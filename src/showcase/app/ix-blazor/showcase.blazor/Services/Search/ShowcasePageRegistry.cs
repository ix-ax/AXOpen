...
public static class ShowcasePageRegistry
{
    ...
    [
        ...
        new()
        {
            ...
            Icon = "play",
            Tags = ["task", "fire and forget", "momentary", "toggle", "remote task", "control flow", "error", "aborted", "state", "disabled", "lock", "display only"],
            SourceFilePaths = [
                ...
                "src/showcase/app/src/core/AXOpen.AxoTask/AxoTaskDisabledExample.st",
        ...
        new()
        {
            ...
            Icon = "document-text",
            Tags = ["KUKA", "robot", "robotics", "KRC4", "KRC5"],
            SourceFilePaths = [
        ...
        new()
        {
            ...
            Category = "Vendor Components",
            Vendor = "Cognex",
            Description = "Practical reference for integrating Cognex vision systems in SIMATIC AX applications with runnable command widgets and live component status. Covers PROFINET (AxoVisionPro) and the TCP/.NET remote-task alternative (AxoVisionProNet).",
            Icon = "document-text",
            Tags = ["Cognex", "vision", "camera", "inspection", "image", "VisionPro", "VisionProNet", "TCP", "remote task"],
            SourceFilePaths = [
                ...
                "src/showcase/app/src/components.cognex.vision/Documentation/AxoVisionProNet.st",
                ...
                "src/components.cognex.vision/ctrl/src/AxoVisionProNet/AxoVisionProNet.st",
                "src/components.cognex.vision/src/AXOpen.Components.Cognex.Vision/AxoVisonProNet/AxoVisionProNet.TcpClient.cs",
