...
namespace AXOpen.Components.Ur.Robotics
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static app_axopen_components_ur_roboticsTwinController SecurePlc { get; }
    ...
    {
        public static app_axopen_components_ur_roboticsTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}
