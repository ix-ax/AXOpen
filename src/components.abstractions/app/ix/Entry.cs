...
namespace components_abstractions_app
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static components_abstractions_appTwinController SecurePlc { get; }
    ...
    {
        public static components_abstractions_appTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}