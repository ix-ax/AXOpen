...
namespace AXOpen.Components.Desoutter.Tightening
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static app_axopen_components_desoutter_tighteningTwinController SecurePlc { get; }
    ...
    {
        public static app_axopen_components_desoutter_tighteningTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}