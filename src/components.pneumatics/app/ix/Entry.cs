...
namespace pneumaticcomponents
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static pneumaticcomponentsTwinController SecurePlc { get; }
    ...
    {
        public static pneumaticcomponentsTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}
