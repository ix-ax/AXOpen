...
[!code-smalltalk[](../../showcase/app/src/Foundation/PneumaticsShowcase.st?name=DeclarationAndHWIO_Assignement)]

#### Initialize & Run

[!code-smalltalk[](../../showcase/app/src/Foundation/PneumaticsShowcase.st?name=Pneumatic_Run)]
...
[!code-smalltalk[](../../showcase/app/src/Foundation/PneumaticsShowcase.st?name=MoveToHome)]
**Example of using MoveToWork method**
[!code-smalltalk[](../../showcase/app/src/Foundation/PneumaticsShowcase.st?name=MoveToWork)]

To stop the movement, when the cylinder is moving, the public `Stop` method is present. 
**Example of using Stop method**
[!code-smalltalk[](../../showcase/app/src/Foundation/PneumaticsShowcase.st?name=Stop)]
>[!NOTE] 
...
[!code-smalltalk[](../../showcase/app/src/Foundation/PneumaticsShowcase.st?name=SuspendMoveToInWhile)]
**Example of using SuspendMoveToOutWhile method**
[!code-smalltalk[](../../showcase/app/src/Foundation/PneumaticsShowcase.st?name=SuspendMoveToOutWhile)]
...
[!code-smalltalk[](../../showcase/app/src/Foundation/PneumaticsShowcase.st?name=AbortMoveToHomeWhen)]
**Example of using AbortMoveToWorkWhen method**
[!code-smalltalk[](../../showcase/app/src/Foundation/PneumaticsShowcase.st?name=AbortMoveToWorkWhen)]
...
[!code-csharp[](../../showcase/app/ix-blazor/showcase.blazor/Pages/Pneumatics/Documentation.razor?name=RenderedView)]
