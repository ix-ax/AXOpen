        ...
        public string ErrorDescription
        {
            get
            {
                ...
                if (errorDescriptionDict.Count == 0)
                {
                    ...
                    errorDescriptionDict.Add(504, "Waiting for the signal/variable `Inputs.Status.NDR` to be inverted !");
                    ...
                    errorDescriptionDict.Add(514, "Waiting for the signal/variable `Inputs.Status.NDR` to be inverted !");
                    ...
                    errorDescriptionDict.Add(525, "Waiting for the signal/variable `Inputs.Status.NDR` to be inverted !");
                    ...
                    errorDescriptionDict.Add(534, "Waiting for the signal/variable `Inputs.Status.NDR` to be inverted !");
                    ...
                    errorDescriptionDict.Add(545, "Waiting for the signal/variable `Inputs.Status.NDR` to be inverted !");
                    ...
                    errorDescriptionDict.Add(552, "Waiting for the signal/variable `Inputs.Status.ACTIVECMD` to be equal to Outputs.Control.CMD (1-ReadUID) !");
                    errorDescriptionDict.Add(553, "Waiting for the signal/variable `Inputs.Status.NDR` to be inverted !");
                    errorDescriptionDict.Add(554, "Waiting for the signal/variable `Inputs.Status.NDR` to be inverted !");
        ...
        public string ActionDescription
        {
            get
            {
                ...
                if (actionDescriptionDict.Count == 0)
                {
                    ...
                    actionDescriptionDict.Add(304, "ReadUID_Task running, waiting for the new data.");
                    actionDescriptionDict.Add(305, "ReadUID_Task running, reading the data.");
                    actionDescriptionDict.Add(306, "ReadUID_Task running, cleaning the tail of the data buffer.");
                    actionDescriptionDict.Add(307, "ReadUID_Task running, <add the detailed description of the current action 8>");
                    actionDescriptionDict.Add(308, "ReadUID_Task running, <add the detailed description of the current action 9>");
                    actionDescriptionDict.Add(309, "ReadUID_Task running, <add the detailed description of the current action 10>");
                    ...
                    actionDescriptionDict.Add(314, "ReadTagFieldTask running, waiting for the new data.");
                    actionDescriptionDict.Add(315, "ReadTagFieldTask running, reading the data.");
                    actionDescriptionDict.Add(316, "ReadTagFieldTask running, cleaning the tail of the data buffer.");
                    actionDescriptionDict.Add(317, "ReadTagFieldTask running, <add the detailed description of the current action 8>");
                    actionDescriptionDict.Add(318, "ReadTagFieldTask running, <add the detailed description of the current action 9>");
                    actionDescriptionDict.Add(319, "ReadTagFieldTask running, <add the detailed description of the current action 10>");
                    ...
                    actionDescriptionDict.Add(327, "WriteTagFieldTask running, <add the detailed description of the current action 8>");
                    actionDescriptionDict.Add(328, "WriteTagFieldTask running, <add the detailed description of the current action 9>");
                    actionDescriptionDict.Add(329, "WriteTagFieldTask running, <add the detailed description of the current action 10>");
                    ...
                    actionDescriptionDict.Add(334, "ReadTask running, waiting for the new data.");
                    actionDescriptionDict.Add(335, "ReadTask running, reading the data.");
                    actionDescriptionDict.Add(336, "ReadTask running, cleaning the tail of the data buffer.");
                    actionDescriptionDict.Add(337, "ReadTask running, <add the detailed description of the current action 8>");
                    actionDescriptionDict.Add(338, "ReadTask running, <add the detailed description of the current action 9>");
                    actionDescriptionDict.Add(339, "ReadTask running, <add the detailed description of the current action 10>");
                    ...
                    actionDescriptionDict.Add(347, "WriteTask running, <add the detailed description of the current action 8>");
                    actionDescriptionDict.Add(348, "WriteTask running, <add the detailed description of the current action 9>");
                    actionDescriptionDict.Add(349, "WriteTask running, <add the detailed description of the current action 10>");
                    ...
                    actionDescriptionDict.Add(350, "ResetTask running, <add the detailed description of the current action 1>");
                    actionDescriptionDict.Add(351, "ResetTask running, <add the detailed description of the current action 2>");
                    actionDescriptionDict.Add(352, "ResetTask running, <add the detailed description of the current action 3>");
                    actionDescriptionDict.Add(353, "ResetTask running, <add the detailed description of the current action 4>");
                    actionDescriptionDict.Add(354, "ResetTask running, <add the detailed description of the current action 5>");
                    actionDescriptionDict.Add(355, "ResetTask running, <add the detailed description of the current action 6>");
                    actionDescriptionDict.Add(356, "ResetTask running, <add the detailed description of the current action 7>");
                    actionDescriptionDict.Add(357, "ResetTask running, <add the detailed description of the current action 8>");
                    actionDescriptionDict.Add(358, "ResetTask running, <add the detailed description of the current action 9>");
                    actionDescriptionDict.Add(359, "ResetTask running, <add the detailed description of the current action 10>");
