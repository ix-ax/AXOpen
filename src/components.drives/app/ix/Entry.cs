...
namespace AXOpen.Components.Drives
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static app_axopen_components_drivesTwinController SecurePlc { get; }
    ...
    {
        public static app_axopen_components_drivesTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}
