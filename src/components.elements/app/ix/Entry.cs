...
namespace elementscomponents
{
    ...
    public class TwinConnectorSelector
    {
        ...
        public static elementscomponentsTwinController SecurePlc { get; }
    ...
    {
        public static elementscomponentsTwinController Plc { get; } = TwinConnectorSelector.SecurePlc;
    }
}
